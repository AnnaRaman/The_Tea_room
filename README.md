...
The Tearoom is an e-commerce website where you can browse and buy teas with an easily navigable and friendly user experience. 
The goal of the site is to sell teas to new and existing customers and allow them to filter their search to find the type of product they would like. 
The site's admin page allows the admin to easily view, add, edit and delete products and orders from the database.
...
|See the recommended teas of the month                                 | gain some inspiration                                           |
...
|Recieve an order confirmation email                                   | so that I know my order has been processed                      | 
...
|See recommendations of other products I may like                      | to give me some inspiration if I'm unsure which tea to purchase |
...
### Home page
- The homepage provides an insight into the site's product. There is a short introduction to the site to provide the user with some information about the teas.
...
### Product list
- To view the product listing, the customer can choose to view all the products at once by selecting the 'All Teas' option in the 'Tea' dropdown in the navbar. Or, they can choose to view a more specific listing based on the tea's category, for example, 'black tea' or 'cold brews'.
...
### User Profile
- The 'My Profile' link is viewable to a user who has registered an account and signed in. This page details the user's delivery details which they have provided and saved, as well as a list of their order history. From this page, the user can edit and update their delivery details.

### Shopping basket
- The shopping basket details the products and their quantities that have been added to the basket. From this page, the user can edit the number of items of a particular product in their basket, or delete a product altogether from their basket. Every time an item is added to the basket, the user is presented with a pop-up in the form of a toast, that confirms that the item has been added to their basket. 

### Payment
- Payment can be made from the checkout page. Once the user has confirmed their purchase and delivery details, they can pay the amount by card which is functioned by Stripe.

### Email confirmation
- Once a user's payment has been successfully processed and their order has been confirmed, they will receive an email confirmation with a summary of their purchase.

### Admin page 
- The shop administrator (superuser) can add, edit and delete products and /or their specific details on the site. 

### Features left to implement:
 - The ability to 'like' a product and have those items saved to a 'my likes' page. 
 - A function that recommends products that the customer may like, based on their likes and other customers' likes.
...
The only fatal error that was identified was 'Error: Misplaced non-space characters inside a table.'. However as there is no visual indicator, i have not overcome the issue.
...
There were no errors apart from lines being too long.
...
| EMAIL_HOST_PASS                      | The password set up for the host email                |
...
## Acknowledgements
I would like to thank my mentor, Felipe Alarcon for the helpful reviews and advice.
I received support from the Code Institute tutors throughout the development process.